...
import com.shindev.rulecalculator.activity.AddParaValueActivity;
...
public class AddAdapter  extends BaseAdapter {
    ...
    public AddAdapter (AddParaValueActivity activity, List<ParamInfo> params, List<String[]> datas) {
